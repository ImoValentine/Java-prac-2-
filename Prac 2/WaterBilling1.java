...
public class WaterBilling {
    public void run(){
        ...
        double tarr_r1 =4.00;
        double tarr_r2 =15.57;
        double tarr_r3 =22.78;
        double tarr_r4 =38.32;
        double tarr_r5 =99.99;
        double tarr_r6 =265.12;
        double val = 0;
        double val2 = 0;
        double val_1 = 0;
        double val_2= 0;
        ...
        double sum6= sum5 +val_r6;
        System.out.println(String.format("%.2f", val2));
        System.out.println("0.0000" +"\t" +"\t"+String.format("%.4f",r1) +"\t"+"\t" +"\t"+ String.format("%.4f",val_r1)+"\t" +"\t" +String.format("%.4f",sum)+"\t"+"\t"+"\t" +tarr_r1+"\t"+"\t"+"\t"+String.format("%.4f",(val_r1*tarr_r1)));
        System.out.println(String.format("%.4f",r1) +"\t" +"\t"+String.format("%.4f",r2)+"\t"+"\t" +"\t" + String.format("%.4f",val_r2)+"\t" +"\t"+ String.format("%.4f",sum2)+"\t"+"\t"+"\t"+tarr_r2+"\t"+"\t"+"\t"+String.format("%.2f",(val_r2*tarr_r2)));
        System.out.println(String.format("%.4f",r2)+ "\t" +"\t"+String.format("%.4f",r3)+"\t"+"\t" +"\t"+String.format("%.4f",val_r3)+"\t"+"\t" + String.format("%.4f",sum3)+"\t"+"\t"+"\t"+tarr_r3+"\t"+"\t"+"\t"+String.format("%.2f",(val_r3*tarr_r3)));
        System.out.println(String.format("%.4f",r3)+ "\t" +"\t"+String.format("%.4f",r4)+"\t"+"\t" +"\t"+String.format("%.4f",val_r4)+"\t" +"\t"+ String.format("%.4f",sum4)+"\t"+"\t"+"\t"+tarr_r4+"\t"+"\t"+"\t"+String.format("%.2f",(val_r4*tarr_r4)));
        System.out.println(String.format("%.4f",r4)+ "\t" +"\t"+String.format("%.4f",r5)+"\t"+"\t" +"\t"+String.format("%.4f", val_r5)+"\t"+"\t" + String.format("%.4f",sum5)+"\t"+"\t"+"\t"+tarr_r5+"\t"+"\t"+"\t"+String.format("%.2f",(val_r5*tarr_r5)));
        System.out.println(String.format("%.4f",r5)+"\t" +"\t"+"    "+"\t"+"\t" +"\t"+String.format("%.4f", val_r6)+"\t"+"\t" + String.format("%.4f",sum6)+"\t"+"\t"+"\t" +tarr_r6+"\t"+"\t"+"\t"+String.format("%.4f",(val_r6*tarr_r6)));
        System.out.println("__________________________");
        System.out.println("subtotal:" +String.format("%.2f", (val2)));
        System.out.println("VAT:" +String.format("%.2f", (val2 *0.14)));
        System.out.println("subtotal:" + String.format("%.2f",(val2 +(val2 *0.14))));
    }
